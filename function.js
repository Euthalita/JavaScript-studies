...
Uma função define um bloco, delimitado por chaves, que tem as sentenças de códigos que serão executados, quando for utilizar aquelas funções, retornando ou não o resultado, normalmente as funções retornam resultados
...
//Para criar uma função, sempre usa-se o function e o nome da função e dentro dos parenteses, colocar os paremetros de entrada, ou seja, os valores que eles
